...
// hienKinh();
 ...
 function testKinh(){
     let result = "";
     dataGlasses.map(glasscolor =>{
         if(glasscolor.price >=0){
             result += `
             <button class="d-block bg-success" id="chonKinh">
             <img src = "${glasscolor.virtualImg}">
             </button>
             `
         }
         document.getElementById("vglassesList").innerHTML = result;
     })
 }
 testKinh();
